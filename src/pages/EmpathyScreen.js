    ...
    render() {
        return (<React.Fragment>
            ...
            <div className="row ml-0 mt-4 ">
                ...
                <div className="col-sm-10"> <img src={graph} style={{ width: 327, height: 156 }} alt={""}/>
            ...
            <div className="row  ml-0 mt-4">
                <div className="col-1">
                    <img src={bg_1} style={{ width: 48, height: 48 }} alt={""}/>
                </div>
                <div className="col-9" style={{ paddingLeft: 30 }}>
                    ...
                    <p style={{ fontSize: 15, fontWeight: '500', fontFamily: 'montserrat-medium', color: '#474A57', marginLeft: 10, textAlign: 'justify', lineHeight: 1.3}}>
            ...
            <div className="row  ml-0 mt-4">
                <div className="col-1">
                    <img src={bg_2} style={{ width: 48, height: 48 }} alt={""} />
                </div>
                <div className="col-9" style={{ paddingLeft: 30 }}>
                    <p style={{ fontSize: 14, fontWeight: '800', fontFamily: 'montserrat-bold', color: '#18191F', marginLeft: 10, textAlign: 'justify', lineHeight: 1.3 }}>
            ...
            <div className="row  ml-0 mt-4">
                <div className="col-1">
                    <img src={bg_3} style={{ width: 48, height: 48 }} alt={""}/>
                </div>
                <div className="col-9" style={{ paddingLeft: 30, }}>
                    <p style={{ fontSize: 14, fontWeight: '800', fontFamily: 'montserrat-bold', color: '#18191F', marginLeft: 10, textAlign: 'justify', lineHeight: 1.3 }}>
            ...
            <div className="row">
                ...
                <div className="col-10">
                    ...
                    }} >  {this.return_content(5, 9)}   <img src={sidearrow} style={{ width: 6, height: 12 }} alt={""} /> </button>
                </div>
                <div className="col-1"> </div>
            </div>
