...
function GamePlay(props) {
    ...
    useEffect(() => {
        ...
        async function setScript() {
            ...
            script.src = "/" + MyConstant.keyList.projectUrl + "/flappy/index.js"
            script.async = true
    ...
    function onLoad() {
        const GODOT_CONFIG = { "args": [], "canvasResizePolicy": 2, "executable": "/" + MyConstant.keyList.projectUrl + "/flappy/index", "experimentalVK": false, "fileSizes": { pck: 1703792, wasm: 17503191 }, "focusCanvas": true, "gdnativeLibs": [] };
