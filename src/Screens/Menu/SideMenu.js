  ...
  <div class="left_col scroll-view">
    ...
    <div class="profile clearfix">
      <div class="profile_pic">
        <img src={process.env.PUBLIC_URL+'/'+MyConstant.keyList.projectUrl+'/images/user.png'} alt="..." class="img-circle profile_img"/>
      </div>
...
<div class="menu_section">
  ...
  <ul class="nav side-menu">
    <li >
        <Link to={"/"+ MyConstant.keyList.projectUrl +"/Level"} ><i class="fa fa-level-up"></i> Level <span class=""></span></Link>
    </li>
  </ul>
