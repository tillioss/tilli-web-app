...
class SignUp extends React.Component {
  ...
  validation(name, value) {
    ...
    switch (name) {
      ...
      case "zipcode":
        if (value.trim() === '') {
          errors[name] = "Please enter zipcode.";
        } else if (/^\+?(0|[1-9]\d*)$/.test(value) == false) {
          errors[name] = "Please enter valid zipcode.";
        } else {
          delete errors[name]
        }
        break;
          ...
          <div className="row mx-0">
            ...
            <div className="col-sm-6">
              <div className="fontuser">
                ...
                <Input
                  type="text"
                  className={(typeof errors['zipcode'] != "undefined" && errors['zipcode'] != "") ? "custom-invalid" : ""}
                  placeholder={this.returnContent(12)} style={{ paddingLeft: 15 }}
                  name="zipcode"
                  handleInputChange={this.handleInputChange}
                  error={(typeof errors['zipcode'] != "undefined" && errors['zipcode'] != "") ? errors['zipcode'] : ""}
                />
