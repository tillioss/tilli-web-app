                ...
                return <div>
                    ...
                    <div className="row">
                        <div className="col-6" style={{ marginTop: 20 }}>
                            {data.content.feelingsDataList[index_value].questions} </div>
                        <div className="col-6">
                            <input type={'text'} value={datavalue} onChange={(e) => {
                    ...
                    <div className="row">
                        ...
                        <div className="col-11" style={{
                            ...
                            {bg_color == '#FFBD12' ?
                                ...
                                }}> {data.content.feelingsDataList[index_value].questions}</p> :
                                <React.Fragment>
                                    <div className="row" style={{ paddingBottom: 25, paddingTop: 25, height: 150, width: "100%", padding: 20 }}>
