                ...
                <div className="module-content">
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div className="pink" style={{ position: 'absolute', minHeight: window.innerHeight / 2.1, }} >
                                <p className="font-24-18"
                                    style={{
                                        //color: '#474A57',
                        ...
                        <div style={{
                            ...
                            <div className="yellow" style={{ position: 'absolute', minHeight: window.innerHeight / 2 }} >
                            </div>
                        </div>
                    </div>
                    <div style={{ position: 'absolute', bottom: '17%', left: '5%', zIndex: 3 }} >
                        <img style={{ width: window.innerHeight / 5 }} src={MyConstant.keyList.apiURL +
