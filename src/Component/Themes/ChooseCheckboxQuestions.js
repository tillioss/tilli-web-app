            ...
            return (
                <div className="col-6" style={{ margin: 0, padding: 0, paddingLeft: 10, marginTop: 10 }} key={index}>
                    ...
                    <div className="box_width" style={{
                        ...
                        <p style={{ paddingTop: 10, fontSize: 16, fontFamily: 'montserrat-medium', lineHeight: 1.0, fontWeight: 400 }}>
                            {checkBox.content}
                        </p>
                    </div>
                </div>
        ...
        width: 128px; min-height: 133px;
            ...
            <div className="module-content">
                <div className="col-12" style={{ margin: 0, padding: 0 }}>
                    ...
                    <div className="row" style={{ paddingLeft: 15, paddingRight: 40, paddingTop: window.innerHeight / 25 }}>
                        {checkBoxes}
                    </div>
                </div>
